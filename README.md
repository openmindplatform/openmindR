...
```
    ...
    ## # … with 16,806 more rows, and 71 more variables: Q3Pre <dbl>,
...
```
    ...
    ##  4 Intell… Intellectua…  0.366 25.4  7.59e-134  4818           0.602
...
```
    ...
    ##  6 Pre       8030    0.486 0.0850 0.000949 0.00186 Q2            V4     

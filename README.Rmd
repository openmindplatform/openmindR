...
calculate_cuteness <- function(person) {
 if(person == "not cute"){
   
  print("Fabio is not cute.")
  cutest_girl <- "Vivi"
  cat(paste("Instead", cutest_girl, "is the cutest\n"))
  
 } 
 if(person == "cute"){
   
  cutest_girl <- "Vivi"
  print(paste(cutest_girl, "is the cutest"))
  
  } 
}

calculate_cuteness(fabio)

```
```{r}

calculate_cuteness(vivi)
